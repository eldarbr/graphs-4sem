...
public class GraphMathOperations {
    ...
    public static boolean containsNegativeWeights(final Graph sourceGraph) {
        final int size = sourceGraph.getVerticesCount();
        final int[][] matrix = sourceGraph.getGraphAdjacencyMatrix();
